...
import Section6 from "./section_head/Section6";
import Section7 from "./section_head/Section7";
import Section8 from "./section_head/Section8";
import Section9 from "./section_head/Section9";
import Section10 from "./section_head/Section10";
import Section11 from "./section_head/Section11";
import Section12 from "./section_head/Section12";
import Section13 from "./section_head/Section13";
import Section14 from "./section_head/Section14";
import Section15 from "./section_head/Section15";
...
export default function Header() {
  ...
  return (
    <header ref={headerRef} className="w-full min-h-screen relative overflow-hidden ">
      {/* Overlay */}
      <div className="absolute inset-0 bg-[#001822] opacity-80 z-5"></div>
...
{/* Background image + overlay olive + PARALLAX dynamique */}
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-[#001822] via-[#002a3a] to-[#001822] opacity-40"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen pt-8 pb-4">
        ...
        <motion.a
          href="#"
          className="inline-block bg-[#1834ebb5] text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:bg-[#ba4b0bce] transition mb-16"
          initial={{ opacity: 0, y: 25 }}
          animate={{ opacity: 1, y: 0 }}
