            ...
            <div className="relative flex flex-col items-center">
                ...
                <div className="absolute bottom-[-40px] flex gap-2">
                    <a href="https://www.youtube.com/@CENIV-Diaspora" target="_blank" rel="noopener noreferrer">
                        <img src="/assets/ico/icone_réseaux/ico/youtube_logo.ico" alt="YouTube" className="w-8 h-8 hover:opacity-80 transition-opacity" />
                    </a>
                    <a href="http://www.tiktok.com/@cenivdiaspora" target="_blank" rel="noopener noreferrer">
                        <img src="/assets/ico/icone_réseaux/ico/tiktok_logo.ico" alt="TikTok" className="w-8 h-8 hover:opacity-80 transition-opacity" />
                    </a>
                </div>
            </div>
        ),
        ...
        icon: (
            <div className="relative flex flex-col items-center">
                ...
                <div className="absolute bottom-[-40px] flex gap-2">
                    ...
                    <img src="/assets/ico/icone_réseaux/ico/facebook_logo.ico" alt="Facebook" className="w-8 h-8 hover:opacity-80 transition-opacity" />
                    </a>
                </div>
            </div>
        ),
